...
def plot_confusion_matrix(y_true, y_pred):
   ...
   plt.savefig(r'C:\Users\SRUTHI\OneDrive\Desktop\Github Folder\DL-Algorithms\RNN\results\test.jpg')
...
model.save(r"C:\Users\SRUTHI\OneDrive\Desktop\Github Folder\DL-Algorithms\RNN\results\model\spam_model")

with open("rnn_smsspam_model.pkl","wb") as model_files:
   pickle.dump(model,model_files)